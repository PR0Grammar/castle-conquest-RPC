...
4. run [java client.Client <int (number of attackers)> <int (number of defenders)> <int (number of gates)> <int (num of spaces)>] OR [java client.Client] on another another window
    ex) 
